    ...
    def step_wait(self):
        for env_idx in range(self.num_envs):
            ...
            if self.buf_dones[env_idx]:
                ...
                # action mask should be updated
                self.buf_infos[env_idx]['terminal_action_mask'] = self.buf_infos[env_idx]['action_mask']
                # reset the action mask
                reset_action_mask = self.envs[env_idx].action_mask
                self.buf_infos[env_idx]['action_mask'] = flatten_action_mask(self.envs[env_idx].action_space, reset_action_mask)
