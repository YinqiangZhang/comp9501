...
def read_scenario(
    scenario_path: str, scenario_name: str = None
...
def read_planning_problem(
    planning_problem_set: PlanningProblemSet, problem_id: int = None
) -> PlanningProblem:
    """
...
def restore_scenario(meta_scenario: Scenario, obstacle_list: List[DynamicObstacle]):
    ...
    old_obstacles = meta_scenario.obstacles
    meta_scenario.remove_obstacle(old_obstacles)
