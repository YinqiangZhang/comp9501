...
PATH_PARAMS = {
    ...
    "configs": ROOT_STR + "/commonroad_rl/gym_commonroad/configs.yaml",
    # configurations for entire project (safe RL implementation in urban scenarios)
    "project_configs": ROOT_STR + "/../project_configs.yml",
}
