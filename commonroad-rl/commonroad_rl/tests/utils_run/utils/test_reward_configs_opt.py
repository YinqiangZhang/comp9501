...
"""
Unit test script for environment configuration optimizing
"""
...
@unit_test
@functional
def test_optimize_reward_configs():
    ...
    file_to_check = "reward_configuration_optimization/report_ppo2_commonroad-v0-10-trials-1000-steps-tpe-median.yml"
