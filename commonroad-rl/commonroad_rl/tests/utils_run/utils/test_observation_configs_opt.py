...
@unit_test
@functional
def test_optimize_observation_configs():
    ...
    log_path = os.path.join(output_path, "observation_optimization_test_log")
    ...
    file_to_check = "observation_configuration_optimization/report_ppo2_commonroad-v0-10-trials-1000-steps-tpe-median.yml"
