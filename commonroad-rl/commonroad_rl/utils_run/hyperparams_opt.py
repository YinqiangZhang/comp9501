...
def optimize_hyperparams(
    ...
    LOGGER.info("Optimizing model hyperparameters for {}".format(algo))
    ...
    LOGGER.info("Number of finished trials: {}".format(len(hyperparams_study.trials)))
    LOGGER.info("Best value: {}".format(hyperparams_study.best_trial.value))
    LOGGER.info("Best model hyperparameters: ")
    LOGGER.info(pformat(hyperparams_study.best_trial.params))
